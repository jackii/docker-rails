...
- Infinitive scrolling (using the [Kaminari](https://github.com/kaminari/kaminari) gem and [vue-infinite-loading](https://github.com/PeachScript/vue-infinite-loading))
